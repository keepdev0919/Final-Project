...
\textbf{[예시] 한 건의 설화가 벡터 DB에 적재되는 과정.}\quad 본 가공 파이프라인이
...
1{,}536차원 벡터화되어 ChromaDB 컬렉션 \texttt{jeju\_folklore\_chunks}에 적재된다.
...
주입된다. 본 시스템은 이러한 가공·검색 경로를 505건 전체 설화·민담에 적용해
1{,}749 청크의 ChromaDB 컬렉션을 구축하였다.
...
비짓제주 관광지와 매핑되지 않은 108건은 현재 ChromaDB 적재만 되어 있고
