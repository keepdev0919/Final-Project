...
⚠️ 2026-09-10에 **데이터까지 지웠다.** 설화 원문(`data/extracted` 505개 파일),
벡터 인덱스(`storage/vector_db` 43MB), `metadata` 테이블 228행, 그리고 이것들을
만들던 스크립트 15개가 모두 없어졌다. 되살리려면 원본 수집부터 다시 해야 한다.
"""
