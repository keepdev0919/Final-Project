...
> 🔴 **[구방향 · 참고자료]** 이 문서는 **실행 정본이 아니다.** 2026-07-14 기준으로 작성돼 07-20 방향 재정립(정보→경험, 비트 명세+런타임 엔진, 성산 1개 집중) **이전**의 전제 위에 서 있다. 특히 **"30개소 이상 양산 · TestFlight 배포 · W1 Retention"** 목표는 현행 전략(양산 지양, 성산 1개 압도적 완성, 공모전용 앱스토어 정식 등록)과 **충돌한다.**
>
> - **방향 SSoT:** [`방향성_재정립_2026-07-20.md`](방향성_재정립_2026-07-20.md) ← 신규 기획·개발은 여기부터
> - **공모전 요건:** [`../관광데이터 개발 공모전/_심사요약.md`](../관광데이터%20개발%20공모전/_심사요약.md)
> - **재활용 가치가 있는 부분:** 지표 정의(§6) · 기술 스택·엔드포인트 설계(§1 백엔드) · 리스크 항목. 스코프·목표·일정은 폐기.
> - **v0.2는 아직 없다.** 공모전 40일 스코프 결정(앱스토어 우선 등록 vs 엔진 신규 구현) 후 작성 예정.

**작성일:** 2026-07-14
**Sprint 기간(당시 계획):** 2026-07-21 ~ 2026-08-17 (4주) — 미실행
**상태:** 🔴 구방향 아카이브 (2026-08-12 정합화 시 정본 라벨 회수)
**당시 목표 산출물:** 쌍방향 도슨트 v0.2 · TestFlight 배포 · W1 Retention 측정 시작
**연관 문서:**
- [방향성_재정립_2026-07-20.md](방향성_재정립_2026-07-20.md) (← 07-14 재정립 문서는 2026-08-12 재편 시 삭제됨)
- [Sprint1_콘텐츠_파이프라인.md](Sprint1_콘텐츠_파이프라인.md)
- [공공데이터.md](공공데이터.md)
- ~~PRD-travel-companion.md~~ (이 PRD에 흡수 후 2026-08-12 삭제)
...
## 12. 발표·심사 대비 매핑 — ⛔ 폐기 (KAIST 트랙)

> **2026-08-12:** 이 섹션이 매핑했던 KAIST OverEdge 발표·IR Day 트랙은 **전면 폐기**됐다.
> 현행 유일 목표는 2026 관광데이터 활용 공모전(1차 9/21 · 최종 10/28)이며,
> 심사 배점·제출 요건 매핑은 [`../관광데이터 개발 공모전/_심사요약.md`](../관광데이터%20개발%20공모전/_심사요약.md)에서 관리한다.
