...
> ⚠️ **[2026-07-20 방향 재정립]** 제목·소개·차별점이 구방향(설화 중심)이라 재작성 대기 중. 새 방향은 "정보가 아니라 경험을 판다 / 설화는 데이터1로 강등 / 해자는 현장 반응형 대화". 현행 방향 SSoT → [`docs/기획/방향성_재정립_2026-07-20.md`](docs/기획/방향성_재정립_2026-07-20.md). (무료 코스 추천 기능은 유지 요소)
...
> 구방향(코스 추천·설화 채팅·일지) 데모 캡쳐 6종은 2026-08-12 재편 때 졸업프로젝트 아카이브(`keepdev/6-1/졸프`)로 저장소 밖으로 분리했다.
> 공모전 제출 빌드 기준 캡쳐로 교체 예정.
...
- **프로젝트 기간**: 2026년 3월 ~ 6월
- **출품**: 2026 관광데이터 활용 공모전 웹·앱 개발 부문 (예비심사 통과 → **1차 심사 자료 제출 마감 9/21 16:00** · 최종 발표심사 10/28)
- **출시 계획**: App Store (**미등록** — 공모전 자격 요건이므로 9/21 전 등록 완료 필요)
- **방향 SSoT**: [`docs/기획/방향성_재정립_2026-07-20.md`](docs/기획/방향성_재정립_2026-07-20.md)
- **공모전 요건**: [`docs/관광데이터 개발 공모전/_심사요약.md`](docs/관광데이터%20개발%20공모전/_심사요약.md)
